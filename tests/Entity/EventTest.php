...
class EventTest extends EntityTestCase {
  public function testRequestParse() {
    ...
    // Node level fields
    $this->assertEquals($event->apiUri(), 'https://radar.squat.net/api/1.0/node/69300100-b104-4c37-b651-48351543e8a6');
    ...
    $this->assertEquals($categories[0]->apiUri(),'https://radar.squat.net/api/1.0/taxonomy_term/e85a688d-03ac-4008-a3cb-1adb7e8f718a');
    $topics = $event->getTopics();
    $this->assertTrue($topics[0] instanceof \Radar\Connect\Entity\TaxonomyTerm);
    $this->assertEquals($topics[0]->apiUri(), 'https://radar.squat.net/api/1.0/taxonomy_term/6c73cff2-9dc9-41db-a79e-f54bf4c010f7');
    // Simple fields.
    ...
    $this->assertEquals($price[0]->apiUri(), 'https://radar.squat.net/api/1.0/taxonomy_term/9d943d0c-e2bf-408e-9110-4bfb044f60c0');
    $this->assertEquals($price[1]->apiUri(), 'https://radar.squat.net/api/1.0/taxonomy_term/6f4101f4-cd9b-49f2-91a3-203d2b47a3ed');
    $groups = $event->getGroups();
    $this->assertTrue($groups[0] instanceof \Radar\Connect\Entity\Group);
    $this->assertEquals($groups[0]->apiUri(), 'https://radar.squat.net/api/1.0/node/0df4bcd7-54b4-4559-a960-60b5042d3d48');
    ...
    $this->assertEquals($locations[0]->apiUri(), 'https://radar.squat.net/api/1.0/location/3c58abc1-e095-4db5-996d-2a064cebb2d3');
  }
}
